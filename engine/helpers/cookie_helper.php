...
if ( ! function_exists('setCookie'))
{
	 ...
	 * @return	void
	 */
	function setCookie($name, $value = '', $expire = '', $domain = '', $path = '/', $prefix = '', $secure = FALSE, $httponly = FALSE)
	{	
		// Set the config file options
		get_instance()->input->setCookie($name, $value, $expire, $domain, $path, $prefix, $secure, $httponly);
	}
}
